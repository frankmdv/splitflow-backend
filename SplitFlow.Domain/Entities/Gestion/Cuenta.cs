...
namespace SplitFlow.Domain.Entities.Gestion
{
    public class Cuenta
    {
        ...
        public virtual ParametroEspecifico TipoCuenta { get; set; }
        public long IdBanco { get; set; }
        public virtual ParametroEspecifico Banco { get; set; }
        public string NombreCuenta { get; set; }
        public long IdMoneda { get; set; }
        public virtual ParametroEspecifico Moneda { get; set; }
